 ...
 *
 * @note This logical queue ID is assocatied with Verbs' ethernet send queue when referring to it in DOCA Flow.
 ...
 *
 * @note This logical queue ID is assocatied with Verbs' ethernet receive queue when referring to it in DOCA Flow.
