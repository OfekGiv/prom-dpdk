 ...
 */
int mrc_ctl_query_device(struct ibv_context *context, struct mrc_ctl_attr *ctl_attr);
 ...
 */
int mrc_ctl_ev_gen_fields_set(struct mrc_context *mrc_ctx, uint8_t *field_widths, int num_fields);
 ...
 * @retval EPERM Process lacks sufficient permissions.
 */
int mrc_ctl_ev_gen_fields_get(struct mrc_context *mrc_ctx, uint8_t **field_widths, int *num_fields);
 ...
 * @retval EPERM Process lacks sufficient permissions.
 */
int mrc_ctl_modify_ev_profile(struct mrc_context *mrc_ctx, struct mrc_ctl_ev_profile *ev_profile);
 ...
 * @retval EPERM Process lacks sufficient permissions.
 */
int mrc_ctl_destroy_ev_profile(struct mrc_context *mrc_ctx, uint64_t ev_profile_id);
 ...
 * @retval EPERM Process lacks sufficient permissions.
 */
int mrc_ctl_get_ev(struct mrc_context *mrc_ctx, uint64_t ev_profile_id, struct mrc_ctl_ev_entry *ev);
 ...
 * @retval EPERM Process lacks sufficient permissions.
 */
int mrc_ctl_replace_ev(struct mrc_context *mrc_ctx, uint64_t ev_profile_id, mrc_ctl_ev_t *ev_old, mrc_ctl_ev_t *ev_new);
 ...
 */
int mrc_ctl_poll_ev_event(struct mrc_cq *ev_cq, int num_entries, struct mrc_ctl_ev_event *ev_event);
